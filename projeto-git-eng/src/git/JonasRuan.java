...
public static void main(String args[]) {
		...
		JOptionPane.showMessageDialog(null, "O resultado da soma ̩: "+resultadosoma);
		JOptionPane.showMessageDialog(null, "O resultado da multiplica̤̣o: "+resultadomult);
		...
		if(numero1 == 0 || numero2 == 0) {
			...
			JOptionPane.showMessageDialog(null, "O resultado da diviṣo: "+resultadodiv);
		}
		
		JOptionPane.showMessageDialog(null, "O resultado da subtra̤̣o: "+resultadosub);
